...
export const ART_WORKS: ArtWork[] = [
  {
    id: 'art-jamini-durga',
    titleBn: 'যামিনী রায়ের দুর্গা ও মহিষাসুর',
    titleEn: 'Durga with Mahishasura - Jamini Roy Masterpiece',
    artistBn: 'যামিনী রায়',
    artistEn: 'Jamini Roy',
    styleCategory: 'Jamini Roy Tempera',
    period: '20th Century Modernist Folk',
    descriptionBn: 'স্বদেশী চেতনায় লোকশিল্পের সরল রেখা ও গাঢ় প্রাকৃতিক রঙে আঁকা মা দুর্গার বিশ্বখ্যাত রূপচিত্র।',
  ...
  },
  {
    ...
    titleBn: 'কালীঘাট পটচিত্র - ত্রিনয়নী আল্পনা',
    titleEn: 'Kalighat Patachitra - Trinayani Motif',
    artistBn: 'পটূয়া শিল্পীবৃন্দ',
    artistEn: 'Traditional Patua Artisans',
    styleCategory: 'Kalighat Patachitra',
    period: '19th Century Folk Scroll Art',
    descriptionBn: 'কলকাতা কালীঘাট মন্দিরের পটুয়াদের ঐতিহ্যবাহী তুলির টানে দেবীর শ্রীমুখ ও আল্পনাচিত্র।',
  ...
  {
    id: 'art-terracotta-temple',
    titleBn: 'বিষ্ণুপুরের পোড়ামাটির মন্দির শিল্প',
    titleEn: 'Bishnupur Terracotta Carvings',
    artistBn: 'মৌল ভূখণ্ডের কারিগরবৃন্দ',
    artistEn: 'Mallabhum Terracotta Artisans',
    styleCategory: 'Terracotta Craft',
    period: '17th-18th Century Malla Dynasty',
    descriptionBn: 'বাঁকুড়া বিষ্ণুপুরের ঐতিহাসিক পোড়ামাটির মন্দিরে খোদাই করা রামায়ণ, মহাভারত ও পূজার দৃশ্যাবলী।',
  ...
  {
    id: 'art-kumartuli-idol',
    titleBn: 'কুমোরটুলির মৃৎশিল্প ও রূপদান',
    titleEn: 'Kumartuli Clay Idol Craftsmanship',
    artistBn: 'কুমোরটুলির পাল মশাইগণ',
    artistEn: 'Kumartuli Sculptor Masters (Pal Family)',
    styleCategory: 'Clay Idol & Kumartuli',
    period: 'Traditional Heritage Guild',
    descriptionBn: 'গঙ্গামাটি, খড় ও কাঠ দিয়ে দেবী দুর্গার প্রতিমা নির্মাণ এবং মহালয়ার দিনে চোখদান (চক্ষুদান)।',
  ...
  {
    id: 'art-tagore-bengal-school',
    titleBn: 'অবনীন্দ্রনাথের ভারতমাতা ও বঙ্গচিত্র',
    titleEn: 'Bengal School of Art - Wash Technique',
    artistBn: 'অবনীন্দ্রনাথ ঠাকুর',
    artistEn: 'Abanindranath Tagore',
    styleCategory: 'Bengal School',
    period: 'Early 20th Century Swadeshi Movement',
    descriptionBn: 'জাপানি ওয়াস প্রযুক্তি ও মুঘল-অজন্তা রীতির মিশ্রণে আধুনিক ভারতীয় চিত্রকলার প্রথম সূচকাগার।',
